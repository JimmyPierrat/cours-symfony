 ...
 * @UniqueEntity(
 *  fields={"title"},
 * message="Une autre annonce posséde le même titre, merci de le modifier !"
 * )
 */
class Ad
{
    ...
    /**
     * @ORM\Column(type="text")
     * @Assert\Length( min=100, minMessage="Votre descriptionne peut pas faire moins de 100 caractères !")
     */
    private $content;
    ...
    public function getAvgRatings() {
        ...
        // Faire la divison pour avoir la moyenne
     ...
     *
     * @return array Un tableau d'objets DateTime représentatnt les jours d'occupation
     */
