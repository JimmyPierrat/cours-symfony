...
class Booking
{
     ...
     * @Assert\GreaterThan("today", message="La date d'arrivée doit être supérieure à celle d'aujourdhui !", groups={"front"})
     */
    private $startDate;
     ...
     *
     * @return array Un tableau d'objets DateTime représentant les jours de ma réservation
     */
